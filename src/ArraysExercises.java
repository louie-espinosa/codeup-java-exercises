...
public class ArraysExercises {
    ...
    private static Person [] addPerson(Person [] waifus, Person newPerson) {
        ...
        Person[] newWaifu = Arrays.copyOf(waifus, waifus.length + 1);//using the Arrays.copyOf java method

        //2. plug newPerson into the last element of the new array.
        newWaifu[newWaifu.length - 1] = newPerson;
...
//            System.out.println(Arrays.toString(numbers));//This lets us see the elements of the array [1, 2, 3, 4, 5]
            ...
            Person[] waifus = {
                    new Person("General", "Esdeath"),
                    new Person("Jill", "Valentine"),
                    new Person("Rin", "Tohsaka")};
            //print waifus
//            System.out.println(Arrays.toString(waifus));
            ...
            for (Person waifu : waifus) {
                ...
                //Make new array that adds to the end of the original array
            }

            waifus = addPerson(waifus, new Person("Erina", "Nakiri"));
            for (Person newWaifu : waifus){
                System.out.println(newWaifu);
            }
        }
    }
